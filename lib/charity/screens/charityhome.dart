...
//         setState(() {
//           isCharityUser = userData['role'] == 'charity';
//         });

//         // Only set up notification listener if user is charity
//         if (isCharityUser) {
//           _listenForCharityRequests();
//         }
//       }
...
//   void _triggerNotification(String productName) {
//     // Only trigger notification if user is charity
//     if (isCharityUser) {
//       AwesomeNotifications().createNotification(
//         content: NotificationContent(
//           id: 10,
